...
halak["combo"] = new hal("Compó","Tinca tinca","doktorhal, cigányhal","https://hu.wikipedia.org/wiki/Compó","compo.jpg");
...
function halinfo(hal1){
    document.getElementById("sugo").style.display = "none";
    document.getElementById("halKep").src = "halak/"+halak[hal].kep;
    document.getElementById("halnev").innerHTML = halak[hal].magyar + ", " + "<i>"+halak[hal].fajmagyar+"</i>"
    if (halak[hal].egyeb != null) {
        document.getElementById("halNev").innerHTML += halak[hal].egyeb;
    }
    document.getElementById("halURL").title = halak[hal].magyar
}